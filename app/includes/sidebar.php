      ...
      <ul>
        ...
        <li class="dropdown active">
          ...
          <ul class="dropdown-menu" style="display: block;">
            <li>
              <a href="installments.php" <?php echo basename($_SERVER['PHP_SELF']) == 'installments.php' ? 'class="active"' : ''; ?>>
                <i class="fas fa-calculator"></i>
                <span>نظام الأقساط</span>
              </a>
            </li>
            <li>
              <a href="all_customers.php" <?php echo basename($_SERVER['PHP_SELF']) == 'all_customers.php' ? 'class="active"' : ''; ?>>
                <i class="fas fa-users"></i>
                <span>جميع العملاء</span>
              </a>
            </li>
            <li>
              <a href="add_customer.php" <?php echo basename($_SERVER['PHP_SELF']) == 'add_customer.php' ? 'class="active"' : ''; ?>>
                <i class="fas fa-user-plus"></i>
                <span>إضافة عميل</span>
              </a>
            </li>
            <li>
              <a href="add_installment.php" <?php echo basename($_SERVER['PHP_SELF']) == 'add_installment.php' ? 'class="active"' : ''; ?>>
                <i class="fas fa-plus-circle"></i>
                <span>إضافة قسط جديد</span>
              </a>
            </li>
            <li>
              <a href="late_installments.php" <?php echo basename($_SERVER['PHP_SELF']) == 'late_installments.php' ? 'class="active"' : ''; ?>>
                <i class="fas fa-clock"></i>
                <span>الأقساط المتأخرة</span>
              </a>
            </li>
            <li>
              <a href="installment_reports.php" <?php echo basename($_SERVER['PHP_SELF']) == 'installment_reports.php' ? 'class="active"' : ''; ?>>
                <i class="fas fa-chart-line"></i>
                <span>تقارير وإحصائيات</span>
              </a>
            </li>
            <li>
              <a href="installment_settings.php" <?php echo basename($_SERVER['PHP_SELF']) == 'installment_settings.php' ? 'class="active"' : ''; ?>>
